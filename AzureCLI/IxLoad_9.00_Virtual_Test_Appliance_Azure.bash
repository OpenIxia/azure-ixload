...
if [ -z $1 ]; then
    ...
    echo "ex: ./Ixia_Azure.bash Ixia_Images_RG ixiavhds9x00"
    exit 1
fi
...
if [ -z $2 ]; then
    ...
    echo "./Ixia_Azure.bash Ixia_Images_RG ixiavhds9x00"
    exit 1
fi
...
#source
source_ixload_ve_client_blob=IxLoad_VE_Client_9.00.vhd
source_virtual_test_appliance_blob=Ixia_Virtual_Test_Appliance_9.00_KVM.vhd
source_ixloadve_account_name=ixloadve900
source_ixload_ve_client_container=ixloadveclient900
source_virtual_test_appliance_container=vta900
source_ixloadve_account_key=EYLDwH0TXT60Y8dv3aTZ9S72Gr3Vs19u8A+wTIZGTI3aXScOl8yh/qv+fTu2BpercUAqIog/CuL6OizWSfH9Wg==

#destination
destination_resource_group_name=$1
destination_account_name=$2
destination_container_name=ixloadve900
destination_ixload_ve_client_blob=IxLoad_VE_Client_9.00.vhd
destination_virtual_test_appliance_blob=Ixia_Virtual_Test_Appliance_9.00.vhd
